      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <!-- start -->
            <CreatePage
                :createPermission="hasPermission('roomType create')"
            />
            <!-- end -->
            ...
            <TableCustom
                ...
                :editPermission="hasPermission('roomType edit')"
                :deletePermission="hasPermission('roomType delete')"
            />
            <!-- Table -->
